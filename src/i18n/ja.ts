...
export const ja = {
  ...
  login: {
    title: "ログイン",
    lead: "メールアドレスとパスワードだけで始められます。以降は入力を求めません。",
    email: "メールアドレス",
    password: "パスワード",
    passwordHint: "8文字以上",
    submit: "ログイン",
  ...
  register: {
    title: "会社の状態を、報告なしで見えるようにする",
    lead: "接続するだけで、日々の予定と会計の動きから会社の状態を読み取ります。入力も報告も要りません。",
    toConnect: "データ源を接続する",
  },

  connect: {
    title: "データ源の接続",
    lead: "接続した分だけ見えるようになります。まだ接続していない項目があっても動きます。",
